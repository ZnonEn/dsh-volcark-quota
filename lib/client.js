	...
	factory: (require) => {
		...
		*/
		...
		function ConfigCard() {
			...
			return h("li", { className: "vq-card" + (open ? " vq-card-open" : "") }, h("button", {
				type: "button",
				className: "vq-card-header",
				"aria-expanded": open,
				onClick: () => setOpen(!open)
			}, h("span", { className: "vq-card-headtext" }, h("span", { className: "vq-card-name" }, "火山方舟额度"), h("span", { className: "vq-card-desc" }, "Coding Plan / Agent Plan 额度实时查看的访问密钥与套餐类型")), dirty ? h("span", { className: "vq-card-pending" }, "未保存") : null, h("span", { className: "vq-card-chevron" + (open ? " vq-card-chevron-open" : "") }, h(Chevron))), open ? h("div", { className: "vq-card-body" }, h("div", { className: "vq-field" }, h("div", { className: "vq-field-head" }, h("label", {
				className: "vq-card-label",
				htmlFor: "vq-cfg-ak"
			}, "AccessKey ID"), h("span", { className: akCfg.configured ? "vq-card-badge" : "vq-card-badge-muted" }, akCfg.configured ? akCfg.source ? "已配置 · " + akCfg.source : "已配置" : "未配置")), h("input", {
				id: "vq-cfg-ak",
				...
				onChange: edit(setAk)
			})), h("div", { className: "vq-field" }, h("div", { className: "vq-field-head" }, h("label", {
				className: "vq-card-label",
				htmlFor: "vq-cfg-sk"
			}, "Secret AccessKey"), h("span", { className: skCfg.configured ? "vq-card-badge" : "vq-card-badge-muted" }, skCfg.configured ? skCfg.source ? "已配置 · " + skCfg.source : "已配置" : "未配置")), h("input", {
				id: "vq-cfg-sk",
				className: "vq-card-input",
				type: "password",
				value: sk,
				...
				onChange: edit(setSk)
			}), h("p", { className: "vq-card-hint" }, "存于 DSH 凭据库（~/.dsh/.credentials.yaml），浏览器不保存密钥。")), h("div", { className: "vq-field" }, h("div", { className: "vq-field-head" }, h("label", {
				className: "vq-card-label",
				htmlFor: "vq-cfg-plan"
			}, "套餐类型")), h("select", {
				id: "vq-cfg-plan",
			...
			}, h("option", { value: "auto" }, "自动探测（coding → agent）"), h("option", { value: "coding" }, "Coding Plan"), h("option", { value: "agent" }, "Agent Plan")), h("p", { className: "vq-card-hint" }, !anyWritable ? "当前凭据来自只读来源（环境变量），请到环境变量处修改。" : "解析优先级：请求体 > 凭据库/环境变量 > 历史别名。")), err ? h("div", { className: "vq-err" }, err) : null, h("div", { className: "vq-card-footer" }, saved ? h("span", { className: "vq-card-saved" }, "已保存，悬浮球已刷新 ✓") : null, anyWritable ? h("button", {
				type: "button",
