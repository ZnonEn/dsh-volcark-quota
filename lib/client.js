	...
	factory: (require) => {
		...
		*/
		...
		const CSS = [
			...
			".vq-card{list-style:none;border:1px solid var(--dsw-alias-border-l2,#e1e6ee);border-radius:12px;background:var(--dsw-alias-bg-layer-1,#fff);overflow:hidden;box-shadow:0 4px 14px rgba(0,0,0,.06)}",
			".vq-card-header{display:flex;align-items:center;gap:10px;width:100%;text-align:left;background:none;border:none;cursor:pointer;padding:14px 16px;font:inherit;color:inherit}",
			".vq-card-header:hover{background:var(--dsw-alias-bg-layer-2,#f5f7fa)}",
			".vq-card-headtext{display:flex;flex-direction:column;gap:2px;flex:1;min-width:0}",
			".vq-card-name{font-size:14px;font-weight:700;color:var(--dsw-alias-label-primary,#17202f)}",
			".vq-card-desc{font-size:11px;color:var(--dsw-alias-label-tertiary,rgba(0,0,0,.55));line-height:1.45}",
			...
			".vq-card-body{display:flex;flex-direction:column;gap:11px;padding:14px 16px 16px;border-top:1px solid var(--dsw-alias-border-l1,#e9edf2);background:var(--dsw-alias-bg-base,#f8f9fb)}",
			".vq-card-field{display:flex;flex-direction:column;gap:4px}",
			".vq-card-label{font-size:11px;font-weight:600;color:var(--dsw-alias-label-secondary,rgba(0,0,0,.6))}",
			".vq-card-input{border:1px solid var(--dsw-alias-border-l2,#dfe5ed);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:7px;padding:8px 10px;font-size:12px;color:var(--dsw-alias-label-primary,#1a1a1a);font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;transition:border-color .15s ease,box-shadow .15s ease}",
			".vq-card-input:focus{outline:none;border-color:var(--dsw-alias-brand-primary,#4f8cff);box-shadow:0 0 0 3px color-mix(in srgb,var(--dsw-alias-brand-primary,#4f8cff) 14%,transparent)}",
			".vq-card-select{border:1px solid var(--dsw-alias-border-l2,#dfe5ed);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:7px;padding:7px 8px;font-size:12px;color:var(--dsw-alias-label-primary,#1a1a1a)}",
			".vq-card-hint{font-size:11px;color:var(--dsw-alias-label-tertiary,rgba(0,0,0,.5));line-height:1.55;padding:8px 10px;border-radius:7px;background:var(--dsw-alias-bg-layer-2,#f0f3f7)}",
			".vq-card-footer{display:flex;align-items:center;gap:10px;padding-top:4px}",
			".vq-card-discard{background:none;border:1px solid var(--dsw-alias-border-l2,#dfe5ed);color:var(--dsw-alias-label-secondary,#5b6575);border-radius:7px;padding:7px 12px;font-size:12px;cursor:pointer}",
			".vq-card-discard:hover{background:var(--dsw-alias-bg-layer-2,#eef1f5)}",
			".vq-card-save{background:var(--dsw-alias-brand-primary,#4f72ce);border:none;color:#fff;border-radius:7px;padding:7px 18px;font-size:12px;font-weight:650;cursor:pointer}",
